...
static LGroupInfo lgroups[] = {
	{N_("Arabic"), LG_ARABIC, NULL},
	{N_("Baltic"), LG_BALTIC, NULL},
	{N_("Central European"), LG_CENTRAL_EUROPEAN, NULL},
	{N_("Chinese"), LG_CHINESE, NULL},
	{N_("Cyrillic"), LG_CYRILLIC, NULL},
	{N_("Greek"), LG_GREEK, NULL},
	{N_("Hebrew"), LG_HEBREW, NULL},
	{N_("Indian"), LG_INDIAN, NULL},
	{N_("Japanese"), LG_JAPANESE, NULL},
	{N_("Korean"), LG_KOREAN, NULL},
	{N_("Turkish"), LG_TURKISH, NULL},
	{N_("Unicode"), LG_UNICODE, NULL},
	{N_("Vietnamese"), LG_VIETNAMESE, NULL},
	{N_("Western"), LG_WESTERN, NULL},
	{N_("Other"), LG_OTHER, NULL},
	{NULL, LG_LAST, NULL}
};
...
static CharsetInfo charset_trans_array[] = {
	{N_("Arabic (IBM-864)"),                  "IBM864",                LG_ARABIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Arabic (IBM-864-I)"),                "IBM864i",               LG_ARABIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Arabic (ISO-8859-6)"),               "ISO-8859-6",            LG_ARABIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Arabic (ISO-8859-6-E)"),             "ISO-8859-6-E",          LG_ARABIC, CI_MINOR, NULL, NULL, NULL},

	{N_("Arabic (ISO-8859-6-I)"),             "ISO-8859-6-I",          LG_ARABIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Arabic (MacArabic)"),                "x-mac-arabic",          LG_ARABIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Arabic (Windows-1256)"),             "windows-1256",          LG_ARABIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Armenian (ARMSCII-8)"),              "armscii-8", 	           LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Baltic (ISO-8859-13)"),              "ISO-8859-13",           LG_BALTIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Baltic (ISO-8859-4)"),               "ISO-8859-4",            LG_BALTIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Baltic (Windows-1257)"),             "windows-1257",          LG_BALTIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Celtic (ISO-8859-14)"),              "ISO-8859-14",           LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Central European (IBM-852)"),        "IBM852",                LG_CENTRAL_EUROPEAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Central European (ISO-8859-2)"),     "ISO-8859-2",	           LG_CENTRAL_EUROPEAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Central European (MacCE)"),          "x-mac-ce",              LG_CENTRAL_EUROPEAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Central European (Windows-1250)"),   "windows-1250",          LG_CENTRAL_EUROPEAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Simplified (GB18030)"),      "gb18030",               LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Simplified (GB2312)"),       "GB2312",                LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Simplified (GBK)"),          "x-gbk",                 LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Simplified (HZ)"),           "HZ-GB-2312",	           LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Simplified (Windows-936)"),  "windows-936",           LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Traditional (Big5)"),        "Big5",                  LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Traditional (Big5-HKSCS)"),  "Big5-HKSCS",	           LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Chinese Traditional (EUC-TW)"),      "x-euc-tw",              LG_CHINESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Croatian (MacCroatian)"),            "x-mac-croatian",        LG_CENTRAL_EUROPEAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Cyrillic (IBM-855)"),                "IBM855",                LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Cyrillic (ISO-8859-5)"),             "ISO-8859-5",	           LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Cyrillic (ISO-IR-111)"),             "ISO-IR-111",	           LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Cyrillic (KOI8-R)"),                 "KOI8-R",                LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Cyrillic (MacCyrillic)"),            "x-mac-cyrillic",        LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Cyrillic (Windows-1251)"),           "windows-1251",          LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Russian (CP-866)"),                  "IBM866",                LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Ukrainian (KOI8-U)"),                "KOI8-U",                LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("Ukrainian (MacUkrainian)"),          "x-mac-ukrainian",       LG_CYRILLIC, CI_MINOR, NULL, NULL, NULL},
	{N_("English (ASCII)"),                   "ANSI_X3.4-1968#ASCII",  LG_WESTERN, CI_MAJOR, NULL, NULL, NULL},
	{N_("Farsi (MacFarsi)"),                  "x-mac-farsi",           LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Georgian (GEOSTD8)"),                "geostd8",               LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Greek (ISO-8859-7)"),                "ISO-8859-7",            LG_GREEK, CI_MINOR, NULL, NULL, NULL},
	{N_("Greek (MacGreek)"),                  "x-mac-greek",           LG_GREEK, CI_MINOR, NULL, NULL, NULL},
	{N_("Greek (Windows-1253)"),              "windows-1253",          LG_GREEK, CI_MINOR, NULL, NULL, NULL},
	{N_("Gujarati (MacGujarati)"),            "x-mac-gujarati",        LG_INDIAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Gurmukhi (MacGurmukhi)"),            "x-mac-gurmukhi",        LG_INDIAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Hebrew (IBM-862)"),                  "IBM862",                LG_HEBREW, CI_MINOR, NULL, NULL, NULL},
	{N_("Hebrew (ISO-8859-8-E)"),             "ISO-8859-8-E",          LG_HEBREW, CI_MINOR, NULL, NULL, NULL},
	{N_("Hebrew (ISO-8859-8-I)"),             "ISO-8859-8-I",          LG_HEBREW, CI_MINOR, NULL, NULL, NULL},
	{N_("Hebrew (MacHebrew)"),                "x-mac-hebrew",          LG_HEBREW, CI_MINOR, NULL, NULL, NULL},
	{N_("Hebrew (Windows-1255)"),             "windows-1255",          LG_HEBREW, CI_MINOR, NULL, NULL, NULL},
	{N_("Hindi (MacDevanagari)"),             "x-mac-devanagari",      LG_INDIAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Icelandic (MacIcelandic)"),          "x-mac-icelandic",       LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Japanese (EUC-JP)"),                 "EUC-JP",                LG_JAPANESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Japanese (ISO-2022-JP)"),            "ISO-2022-JP",           LG_JAPANESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Japanese (Shift_JIS)"),              "CP932",             LG_JAPANESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Korean (EUC-KR)"),                   "EUC-KR",                LG_KOREAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Korean (ISO-2022-KR)"),              "ISO-2022-KR",           LG_KOREAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Korean (JOHAB)"),                    "x-johab",               LG_KOREAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Korean (UHC)"),                      "x-windows-949",         LG_KOREAN, CI_MINOR, NULL, NULL, NULL},
	{N_("Nordic (ISO-8859-10)"),              "ISO-8859-10",           LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Romanian (MacRomanian)"),            "x-mac-romanian",        LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Romanian (ISO-8859-16)"),            "ISO-8859-16",           LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("South European (ISO-8859-3)"),       "ISO-8859-3",            LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Thai (TIS-620)"),                    "TIS-620",               LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Turkish (IBM-857)"),                 "IBM857",                LG_TURKISH, CI_MINOR, NULL, NULL, NULL},
	{N_("Turkish (ISO-8859-9)"),              "ISO-8859-9",            LG_TURKISH, CI_MINOR, NULL, NULL, NULL},
	{N_("Turkish (MacTurkish)"),              "x-mac-turkish",         LG_TURKISH, CI_MINOR, NULL, NULL, NULL},
	{N_("Turkish (Windows-1254)"),            "windows-1254",          LG_TURKISH, CI_MINOR, NULL, NULL, NULL},
	{N_("Unicode (UTF-7)"),                   "UTF-7",                 LG_UNICODE, CI_MINOR, NULL, NULL, NULL},
	{N_("Unicode (UTF-8)"),                   "UTF-8",                 LG_UNICODE, CI_MAJOR, NULL, NULL, NULL},
	{N_("Unicode (UTF-16BE)"),                "UTF-16BE",              LG_UNICODE, CI_MINOR, NULL, NULL, NULL},
	{N_("Unicode (UTF-16LE)"),                "UTF-16LE",              LG_UNICODE, CI_MINOR, NULL, NULL, NULL},
	{N_("Unicode (UTF-32BE)"),                "UTF-32BE",              LG_UNICODE, CI_MINOR, NULL, NULL, NULL},
	{N_("Unicode (UTF-32LE)"),                "UTF-32LE",              LG_UNICODE, CI_MINOR, NULL, NULL, NULL},
	{N_("User Defined"),                      "x-user-defined",        LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{N_("Vietnamese (TCVN)"),                 "x-viet-tcvn5712",       LG_VIETNAMESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Vietnamese (VISCII)"),               "VISCII",                LG_VIETNAMESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Vietnamese (VPS)"),                  "x-viet-vps",            LG_VIETNAMESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Vietnamese (Windows-1258)"),         "windows-1258",          LG_VIETNAMESE, CI_MINOR, NULL, NULL, NULL},
	{N_("Visual Hebrew (ISO-8859-8)"),        "ISO-8859-8",            LG_HEBREW, CI_MINOR, NULL, NULL, NULL},
	{N_("Western (IBM-850)"),                 "IBM850",                LG_WESTERN, CI_MINOR, NULL, NULL, NULL},
	{N_("Western (ISO-8859-1)"),              "ISO-8859-1",            LG_WESTERN, CI_MAJOR, NULL, NULL, NULL},
	{N_("Western (ISO-8859-15)"),             "ISO-8859-15",           LG_WESTERN, CI_MINOR, NULL, NULL, NULL},
	{N_("Western (MacRoman)"),                "x-mac-roman",           LG_WESTERN, CI_MINOR, NULL, NULL, NULL},
	{N_("Western (Windows-1252)"),            "windows-1252",          LG_WESTERN, CI_MINOR, NULL, NULL, NULL},
	/* charsets without possibly translatable names */
	{"T61.8bit",                              "T61.8bit",              LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{"x-imap4-modified-utf7",                 "x-imap4-modified-utf7", LG_UNICODE, CI_MINOR, NULL, NULL, NULL},
	{"x-u-escaped",                           "x-u-escaped",           LG_OTHER, CI_MINOR, NULL, NULL, NULL},
	{NULL,                                    NULL,                    LG_LAST, 0, NULL, NULL, NULL}
};
