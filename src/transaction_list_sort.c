									   ...
									   GtkSortType new_sort_order)
{
    ...
    gtk_tree_view_column_set_sort_indicator (transactions_tree_view_columns[custom_list->sort_col], FALSE);
    gtk_tree_view_column_set_sort_indicator (transactions_tree_view_columns[new_sort_col], TRUE);
    gtk_tree_view_column_set_sort_order (transactions_tree_view_columns[new_sort_col], new_sort_order);
